...
import scipy as sc               # vi phan, xu ly tin hieu
'''*************************************************************
* global specific
*************************************************************'''
# Cac bieu do
...
cw_fs = cw_f*cw_sample  # (depend) Tan so lay mau theo song mang 
...
# Tin hieu
N_bit = 10000           # (random) So luong bit can mo phong, random du nhieu
...
# Power Amplifier
pa_a1 = 5/(cw_Arms**2)   # Cac he so khuech dai
...
at1_l = 1/cw_f          # (Tham khao bai tap) buoc song - wavelength (m)
at1_G = None            # (depend) cong thuc antenna Gain

#  rain loss
rl_a = 3                # (Tham khao bai tap) he so suy hao do mua (3dB/Km - vietnam)
rl_hr = 5000            # (Tham khao bai tap) do cao chiu mua - km
rl_ha = 100             # (Tham khao bai tap) do cao anten vs nuoc bien - km
